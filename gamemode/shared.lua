...
TEAM_CARDEALER = AddExtraTeam( "Car Dealer", {
	color = Color( 255, 221, 0, 255 ), --Dark yellow
	model = {
		"models/player/hostage/hostage_01.mdl",
		"models/player/hostage/hostage_02.mdl"
	},
	description = [[You put people on a new set of wheels!
		Set fair prices, be a professional salesman,
		and offer the widest selection to be successful!]],
	weapons = {},
	command = "cardealer",
	max = 4,
	salary = 25,
