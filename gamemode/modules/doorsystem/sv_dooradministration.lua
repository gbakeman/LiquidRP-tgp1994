...
local function ccLock(ply, cmd, args)
	...
	MySQLite.query("REPLACE INTO "..DB.Prefix.."_door VALUES("..MySQLite.SQLStr(trace.Entity:doorIndex())..", "..MySQLite.SQLStr(string.lower(game.GetMap()))..", "..MySQLite.SQLStr(trace.Entity:getKeysTitle() or "")..", 1, "..(trace.Entity:getKeysNonOwnable() and 1 or 0)..");")
...
local function ccUnLock(ply, cmd, args)
	...
	if not trace.Entity:CreatedByMap() then return end
	MySQLite.query("REPLACE INTO "..Prefix.."_door VALUES("..MySQLite.SQLStr(trace.Entity:doorIndex())..", "..MySQLite.SQLStr(string.lower(game.GetMap()))..", "..MySQLite.SQLStr(trace.Entity:getKeysTitle() or "")..", 0, "..(trace.Entity:getKeysNonOwnable() and 1 or 0)..");")
