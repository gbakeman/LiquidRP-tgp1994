...
rp_languages.english = {
	...
	hints = {"You can be arrested for buying or owning an illegal weapon!",
	"Read the rules near the spawn!",
	...
	"Type /sleep to fall asleep.",
	"Your money and RP name and inventory are saved forever and never dropped on death.",
	...
	"Type /price <Price> while looking at a drug lab or gun lab to set the customer purchase price.",
	...
	"Type /holster to holster your current weapon to inventory",
	"Type /dropmoney <Amount> to drop a money amount.",
	"Type /buymoneyprinter to buy an upgradable Money Printer.",
	"Type /doctor - To become a Doctor.",
	...
	"Press F1 while looking at a player to request a trade.",
