...
LDRP_SH.ShowTutorial = true

LDRP_SH.ConfiscateCash = 200 -- How much cops get for confinscating PRINTERS

LDRP_SH.DisableQMenu = false -- Should the custom q menu be disabled?

LDRP_SH.ReplaceSkybox = true -- Should the gamemode replace the skybox with a much happier one?
...
function LDRP.AddWeapon(class,nicename,description,model,weight)
	LDRP.AddNewItem(class,description,model,weight,Color(255,255,255,255),"",class,function(ply)
...
LDRP.AddWeapon("weapon_real_cs_sg550", "SIG SG-550 Sniper", "Weak, but precise automatic sniper rifle at 500 RPM.",
	"models/weapons/w_snip_sg550.mdl", 1.2)
...
LDRP.CreateCraftItem("Pistol Ammo Crate","models/Items/357ammo.mdl",8,1,80,{["stone"] = 8},{["pistol ammo"] = 1})
LDRP.CreateCraftItem("Rifle Ammo Crate","models/Items/BoxSRounds.mdl",9,1,80,{["stone"] = 11},{["rifle ammo"] = 1})
LDRP.CreateCraftItem("Shotgun Ammo Crate","models/Items/BoxBuckshot.mdl",9,1,80,{["stone"] = 11},{["shotgun ammo"] = 1})
LDRP.CreateCraftItem("Shotgun Upgrade","models/Items/BoxBuckshot.mdl",15,2,120,{["weapon_real_cs_pumpshotgun"] = 1,["stone"] = 12},{["weapon_real_cs_xm1014"] = 1})
LDRP.CreateCraftItem("Rifle Upgrade","models/Items/BoxBuckshot.mdl",18,3,140,{["ls_sniper"] = 3,["gold"] = 3},{["weapon_real_cs_g3sg1"] = 1})
LDRP.CreateCraftItem("Double Pistols","models/weapons/w_pist_elite.mdl",16,2,140,{["weapon_real_cs_usp"] = 2},{["weapon_real_cs_elites"] = 1})
LDRP.CreateCraftItem("Galil","models/weapons/w_rif_galil.mdl",18,3,150,{["weapon_real_cs_ak47"] = 2,["gold"] = 5},{["weapon_real_cs_galil"] = 1})
